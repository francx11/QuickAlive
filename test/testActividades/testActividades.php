...
class TestActividades extends TestCase
{
    ...
    public function testInsertarActividadSimple()
    {
        ...
        $subTipoActividad = 'SubSimple';
        $duracion = 60; // Duración en minutos

        // Ejecutar la función que se está probando
        $idActividad = $this->bd->insertarActividadSimple($nombreActividad, $descripcion, $tipoActividad, $subTipoActividad, $duracion);
        ...
        $this->assertEquals($subTipoActividad, $actividadInsertada->getSubTipoActividad());
...
// Insertar una actividad de prueba para luego modificarla
        ...
        $subTipoActividadOriginal = 'SubSimple';
        $duracionOriginal = 60;

// Insertar la actividad de prueba
        $idActividad = $this->bd->insertarActividadSimple($nombreActividad, $descripcionOriginal, $tipoActividadOriginal, $subTipoActividadOriginal, $duracionOriginal);
...
// Datos de modificación
        ...
        $nuevoSubTipoActividad = 'SubCompleja';
        $nuevaDuracion = 90;

// Ejecutar la función que se está probando
        $resultado = $this->bd->modificarActividad($idActividad, $nuevoNombreActividad, $nuevaDescripcion, $nuevoTipoActividad, $nuevoSubTipoActividad, $nuevaDuracion);
...
// Verificar si los datos de la actividad han sido modificados correctamente
        ...
        $this->assertEquals($nuevoSubTipoActividad, $actividadModificada->getSubTipoActividad());
...
// Insertar algunas actividades de prueba
        ...
        $idActividad1 = $this->bd->insertarActividadSimple($actividad1['nombreActividad'], $actividad1['descripcion'], $actividad1['tipoActividad'], $actividad1['subTipoActividad'], $actividad1['duracion']);

        $actividad2 = array(
            'nombreActividad' => 'Actividad de prueba 2',
            'descripcion' => 'Esta es una actividad de prueba 2',
            'tipoActividad' => 'Compleja',
            'subTipoActividad' => 'SubCompleja',
            'duracion' => 120,
        );
        $idActividad2 = $this->bd->insertarActividadSimple($actividad2['nombreActividad'], $actividad2['descripcion'], $actividad2['tipoActividad'], $actividad2['subTipoActividad'], $actividad2['duracion']);
...
// Función para convertir un objeto Actividad a un array asociativo
    private function toArray($actividad)
    {
        return array(
            ...
            'subTipoActividad' => $actividad->getSubTipoActividad(),
...
// Verificar si los datos de la actividad coinciden con los esperados
        ...
        $this->assertEquals($subTipoActividad, $actividad->getSubTipoActividad());
